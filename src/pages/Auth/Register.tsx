  ...
  return (
    <>
      ...
      <div className="min-h-[calc(100vh-4rem)] flex justify-center items-center">
        ...
        >
          <h2 className="text-4xl text-blue-400 text-center mb-2">Crear Cuenta</h2>
          ...
          {selectedRole === "2" && (
            <>
              ...
              {mastersError && <p className="text-red-500">{mastersError}</p>}
                ...
                >
                  ...
                  {masters.map((master) => (
                    <option key={master.master_id} value={master.master_id}>
                      {master.name} {master.lastname} ({master.acronym})
                    </option>
                  ))}
                </select>
              )}
